        ...
        <div className="devices-grid">
          <div className="device-card mobile">
            ...
            <div className="device-status">
              <div
                className={`status-dot ${metrics.connectedDevices.mobile > 0 ? "active" : "inactive"}`}></div>
            </div>
          </div>
          ...
          <div className="device-card tablet">
            ...
            <div className="device-status">
              <div
                className={`status-dot ${metrics.connectedDevices.tablet > 0 ? "active" : "inactive"}`}></div>
            </div>
          </div>
          ...
          <div className="device-card web">
            ...
            <div className="device-status">
              <div
                className={`status-dot ${metrics.connectedDevices.web > 0 ? "active" : "inactive"}`}></div>
            </div>
          </div>
          ...
          <div className="device-card test">
            ...
            <div className="device-status">
              <div
                className={`status-dot ${metrics.connectedDevices.test > 0 ? "active" : "inactive"}`}></div>
            </div>
          </div>
        </div>
      </div>
